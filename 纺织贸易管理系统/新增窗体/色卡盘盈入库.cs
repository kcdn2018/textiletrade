...
{
    public partial class 色卡盘盈入库 : Form
    {
        ...
        { 
            ...
            txtdanhao.Text = BianhaoBLL.CreatDanhao(FirstLetter.色卡盘盈单, dateEdit1.DateTime, DanjuLeiXing.色卡盘盈单);
