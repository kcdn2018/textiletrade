namespace 纺织贸易管理系统.选择窗体
{
    partial class 品种选择
    {
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(品种选择));
            this.menuStrip1 = new System.Windows.Forms.MenuStrip();
            this.新增ToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            this.初始页面只显示100条数据ToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
            ...
            // 
            // 初始页面只显示100条数据ToolStripMenuItem
            // 
            this.初始页面只显示100条数据ToolStripMenuItem.Enabled = false;
            this.初始页面只显示100条数据ToolStripMenuItem.ForeColor = System.Drawing.Color.Red;
            this.初始页面只显示100条数据ToolStripMenuItem.Name = "初始页面只显示100条数据ToolStripMenuItem";
            this.初始页面只显示100条数据ToolStripMenuItem.Size = new System.Drawing.Size(161, 36);
            this.初始页面只显示100条数据ToolStripMenuItem.Text = "初始页面只显示100条数据";
            // 
            // groupPanel1
            // 
