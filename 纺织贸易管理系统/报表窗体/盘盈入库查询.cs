...
namespace 纺织贸易管理系统.报表窗体
{
    public partial class 盘盈入库查询 : Form
    {
        ...
        private void query()
        {
            ...
            var querystring = $"select danjutable.*,danjumingxitable.* from danjutable,danjumingxitable  where danjutable.rq between '{ Convert.ToDateTime(dateEdit1.Text)}' and '{Convert.ToDateTime(dateEdit2.Text)}' " +
